...
export default function ManageUsers({ isLoading, setIsLoading }) {
  ...
  const fetchUsers = async () => {
    try {
      ...
      const response = await fetch(
        'https://apj-quotation-backend.vercel.app/getAllUsers'
      );
  ...
  const handleAddUser = async (e) => {
    ...
    try {
      const response = await fetch(
        `https://apj-quotation-backend.vercel.app/addUser/username=${formUsername}/password=${formPassword}/admin=${formIsAdmin}`
      );
      const data = await response.json();
      if (data.success) {
  ...
  const handleDelete = async (username) => {
    ...
    try {
      const response = await fetch(
        `https://apj-quotation-backend.vercel.app/deleteUser/username=${username}`
      );
      const data = await response.json();
      if (data.success) {
        setToast(data.message);
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      setIsLoading(true);
      const response = await fetch(
        `https://apj-quotation-backend.vercel.app/addEditedUser/username=${editUser.USERNAME}/password=${editPassword}/admin=${editIsAdmin}`
      );
      const data = await response.json();
      if (data.success) {
        setToast(data.message);
