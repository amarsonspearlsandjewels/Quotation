          ...
          <div className="golddataval">
            {(() => {
              ...
              const calculatedNetWeight =
                parseFloat(item.grossWeight) - totalStoneWeightGms;
              ...
              <div key={index} className="productdesc-material-item">
                ...
                <div className="material-details">
                  ...
                  <span className="material-price">
                    @ ₹{formatAmount(material.price)}
                  </span>
                  <span className="material-total">
                    = ₹{formatAmount(material.quantity * material.price)}
                  </span>
                </div>
              </div>
            ))}
              ...
              <div className="breakdown-content">
                <div className="breakdown-item">
                  ...
                  <span className="breakdown-value">
                    ₹{formatAmount(item.pricingBreakdown.goldCharges)}
                  </span>
                </div>
                <div className="breakdown-item">
                  <span className="breakdown-label">Wastage Charges:</span>
                  <span className="breakdown-value">
                    ₹{formatAmount(item.pricingBreakdown.wastageCharges)}
                  </span>
                </div>
                <div className="breakdown-item">
                  <span className="breakdown-label">Making Charges:</span>
                  <span className="breakdown-value">
                    ₹{formatAmount(item.pricingBreakdown.makingCharges)}
                  </span>
                </div>
                <div className="breakdown-item">
                  <span className="breakdown-label">Material Charges:</span>
                  <span className="breakdown-value">
                    ₹{formatAmount(item.pricingBreakdown.materialCharges)}
                  </span>
                </div>
                ...
                <div className="breakdown-item">
                  <span className="breakdown-label">
                    GST ({item.pricingBreakdown.gstPercent}%):
                  </span>
                  <span className="breakdown-value">
                    ₹
                    {formatAmount(
                ...
                <div className="breakdown-item breakdown-final">
                  ...
                  <span className="breakdown-value">
                    ₹{formatAmount(item.pricingBreakdown.finalPrice)}
                  </span>
                </div>
              </div>
            ) : (
